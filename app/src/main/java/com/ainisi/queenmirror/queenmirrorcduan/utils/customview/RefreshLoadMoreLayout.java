...
import com.ainisi.queenmirror.queenmirrorcduan.utils.customview.rlm.RlmScrollView;
...
public class RefreshLoadMoreLayout extends ViewGroup {
    ...
    private void initCommonViews(TypedArray typedArray) {
        int[] colors = new int[]{
                getColor(R.color.white), getColor(R.color.alpha_45_black)
        };
    ...
    private void initHeaderViews(TypedArray typedArray) {
        String[] strings = new String[]{
                ...
                getString(R.string.rll_header_time_houxrs),
        ...
        float[] sizes = new float[]{
                getDimen(R.dimen.comment_18_size),
                getDimen(R.dimen.comment_21_dip),
                getDimen(R.dimen.comment_21_dip),
                getDimen(R.dimen.comment_14_size),
                getDimen(R.dimen.comment_15_size),
                getDimen(R.dimen.comment_12_dip),
                getDimen(R.dimen.comment_60_dip)
        };
    ...
    private void initFooterViews(TypedArray typedArray) {
        ...
        float[] sizes = new float[]{
                getDimen(R.dimen.comment_8_dip),
                getDimen(R.dimen.comment_18_dip),
                getDimen(R.dimen.comment_14_size),
                getDimen(R.dimen.comment_45_dip)
        };
    ...
    public static class Config {
        ...
        public Config showLastRefreshTime(Context currActivityClass, String dateFormat) {
